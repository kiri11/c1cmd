...
def main():
    ...
    try:
        ...
        expected_tools = {
            ...
            "get", "set", "add", "reset", "diff", "dump", "preview", "operation_status", "request_status", "geometry_set"
        }
        ...
        print(f"  ✓ All 20 tools discovered with complete schemas: {sorted(list(tool_names))}")
        passed_tests += 1
